...
(
    ...
    PRIMARY KEY (magazine_id, comic_name),
    FOREIGN KEY (magazine_id) REFERENCES magazines (id) ON DELETE CASCADE
);
-- 创建settings表
...
INSERT INTO users (username,
                   ...
                   user_bio,
                   user_position)
VALUES ('Alice', 'alice.jpg', '0', '管理员用户', 1),
       ('Bob', 'bob.jpg', '0', '编辑用户', 2),
       ('Charlie', NULL, '0', NULL, 1),
       ('Dave', 'dave.jpg', '0', '访客用户', NULL);
```